...
public class TCPServer {
    public static void main(String[] args) {
        try {
            ...
            byte[] bufIn = new byte[20]; // buffer de recepção

            System.out.print("[ Aguardando recebimento de mensagem   ..............  ");
            int size = is.read(bufIn); // Operação bloqueante (aguardando chegada de dados)
            System.out.println("[OK] ]");
            
            String msg = new String(bufIn); // Mapeando vetor de bytes recebido para String
